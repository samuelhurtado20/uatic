...
<footer>
	        <div id="iniciar2">
                	<img id="imagen" src="<?php echo BASE_URL;?>views/registro/imagenes/<?php echo Session::get('foto'); ?>" width="80%" align="middle">           	
            </div>
            <div id="captcha2">
                	<label>usuario:</label>
                	<br>
	        ...
	        <div id="enviar2">
            	<form name="form1" method="post" action="<?php echo BASE_URL;?>login/cerrar/">
            		<input type="submit" value='SALIR ' class="btn btnentrar">
            	</form>            
        	</div>
